...
var getSuffix = require("./getSuffix");
var getDayOfYear = require("./getDayOfYear");
var getWeekOfYear = require("./getWeekOfYear");
var getDaysInMonth = require("./getDaysInMonth");
var isLeapYear = require("./isLeapYear");
var getGMTOffset = require("./getGMTOffset");
var getTimezone = require("./getTimezone");
var isDST = require("./isDST");
var getShortMonthName = require("./getShortMonthName");
var getTimezoneName = require("./getTimezoneName");
...
var formatCodes = {
    ...
    B: function B(date) {
        ...
        var secs = date.getHours() * 3600 + date.getMinutes() * 60 + date.getSeconds() + off * 60;
    ...
    c: function c(date) {
        //ISO-8601 -- GMT format
        return [getFormatCode('Y')(date), '-', getFormatCode('m')(date), '-', getFormatCode('d')(date), 'T', getFormatCode('H')(date), ':', getFormatCode('i')(date), ':', getFormatCode('s')(date), getFormatCode('P')(date)].join('');
    },
    //RFC 822 格式的日期    例如：Thu, 21 Dec 2000 16:01:07 +0200
    r: function r(date) {
        return [getFormatCode('D')(date), ', ', getFormatCode('d')(date), ' ', getFormatCode('M')(date), ' ', getFormatCode('Y')(date), ' ', getFormatCode('H')(date), ':', getFormatCode('i')(date), ':', getFormatCode('s')(date), ' ', getFormatCode('O')(date)].join('');
    },
